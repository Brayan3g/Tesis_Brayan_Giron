...
% CONEXIÓN POLOLU #2 
robot2_no = 3; % Seleccionar el agente específico a emplear

% CONEXIÓN POLOLU #3 
robot3_no = 4; % Seleccionar el agente específico a emplear
...
posiciones_ant = [posx1,posy1; posx2, posy2; posx3, posy3];  % Almacena posiciones anteriores para el algoritmo de Verlet
