...
robot2_no = 8; % Identificación del robot 2
robot3_no = 9; % Identificación del robot 3 (si existe)
robot4_no = 4; % Identificación del robot 4 (si existe)
...
robot4 = robotat_3pi_connect(robot4_no)  % Si se tiene un cuarto robot
...
paso_tiempo = 0.001;
num_particulas = 4; % Número de robots
...
posiciones_ant = [posx1, posy1; posx2, posy2; posx3, posy3; posx4, posy4];  % Inicializar posiciones
...
for paso = 1:num_pasos
    ...
    if num_particulas >= 3
        ...
        robotat_3pi_set_wheel_velocities(robot4, velocidades_rpm(4, 1), velocidades_rpm(4, 2));
    end
