...
robot1_no = 7; % Identificación del robot 1
robot2_no = 4; % Identificación del robot 2
robot3_no = 6; % Identificación del robot 3 (si existe)
...
robotat_3pi_set_wheel_velocities(robot3, -70, -70);
...
epsilon = 800; % intensidad
sigma = 0.22;%0.18;%25 % alcance

%----------------------------------------------
% Inicialización de controlador PID
kpO1 = 0.8; kiO1 = 0.001; kdO1 = 0; %0.5,  0.65
eP = 10;  EO = 0;  eO_1 = 0; 
%ROBOT2:
kpO = 0.5; kiO = 0.001; kdO = 0;
...
% Obtener el tiempo de inicio de la simulación
...
%      yg2 = xi1(2)
    ...
    % ROBOT3:
    if eP3 < 0.25
        v3 = 0; w3 = 0;% revisar posible de mas
    end
    ...
    % ROBOT3:
    v_left3 = (0 - wheel_distance * w3) / wheel_radius;
    v_right3 = (0 + wheel_distance * w3) / wheel_radius;
    ...
    velocidades_rpm(3, 1) =  velocidades_rpm(3, 1) + v_left3
    velocidades_rpm(3, 2) =  velocidades_rpm(3, 2) + v_right3
